...
public class MyOItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.myo_list);
        ...
        BNV.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.Category:
                        Intent intent = new Intent(getApplicationContext(), MyOItemListActivity.class);
                    ...
                    case R.id.Chatting:
                        ...
                        return true;
                    case R.id.WishList:
                        Intent intent2 = new Intent(getApplicationContext(), MyOItemListActivity.class);
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(MyOItemListActivity.this,
