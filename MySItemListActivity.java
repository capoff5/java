...
public class MySItemListActivity extends AppCompatActivity {
    ...
    private ArrayList<MySItemData> mArrayList;
    private MySItemsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mys_list);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.Chatting:
                        ...
                        return true;
                    case R.id.WishList:
                        Intent intent2 = new Intent(getApplicationContext(), MySItemListActivity.class);
        ...
        mAdapter = new MySItemsAdapter(this, mArrayList);
        ...
        button_all.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                task.execute( "http://" + IP_ADDRESS + "/p_mys.php", "");
            }
        });
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(MySItemListActivity.this,
    ...
    private void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                MySItemData itemData = new MySItemData();
