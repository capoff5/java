...
public class WishListActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.wish__list);
            ...
            BNV.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()){
                        case R.id.Category:
                            Intent intent = new Intent(getApplicationContext(), com.dongyang.gg.ItemListActivity.class);
                        ...
                        case R.id.Chatting:
                            ...
                            return true;
                        case R.id.WishList:
                            Intent intent2 = new Intent(getApplicationContext(), com.dongyang.gg.ItemListActivity.class);
            ...
            button_all.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    task.execute( "http://" + IP_ADDRESS + "/wish_list.php", id);
                }
            });
