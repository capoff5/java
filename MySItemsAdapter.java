...
public class MySItemsAdapter extends RecyclerView.Adapter<MySItemsAdapter.CustomViewHolder> {

    private ArrayList<MySItemData> mList = null;
    private Activity context = null;


    public MySItemsAdapter(Activity context, ArrayList<MySItemData> list) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mys_list_test, null);
