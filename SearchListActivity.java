...
public class SearchListActivity extends AppCompatActivity {
    ...
    private ArrayList<SItemData> mArrayList;
    private SItemsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_slist);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.Chatting:
                        ...
                        return true;
                    case R.id.WishList:
                        Intent intent2 = new Intent(getApplicationContext(), SearchListActivity.class);
        ...
        mAdapter = new SItemsAdapter(this, mArrayList);
        ...
        button_all.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                task.execute( "http://" + IP_ADDRESS + "/search.php", key);
            }
        });
...
//                Intent intent = new Intent(getApplicationContext(), Item_RegistActivity.class);
//                startActivity(intent);
//            }
//        });
    }
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(SearchListActivity.this,
