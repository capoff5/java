...
public class ItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.Chatting:
                        ...
                        return true;
                    case R.id.WishList:
                        Intent intent2 = new Intent(getApplicationContext(), ItemListActivity.class);
        ...
        mAdapter = new ItemsAdapter(this, mArrayList);
        ...
        button_all.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                task.execute( "http://" + IP_ADDRESS + "/print_i.php", i_type);
            }
        });
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ItemListActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            String i_type=(String)params[1];
            String postParameters="&i_type="+i_type;
